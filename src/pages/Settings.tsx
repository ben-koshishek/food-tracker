...
export function Settings() {
    ...
    const handleImport = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            setMessage({
                type: 'error',
                text: 'Failed to import data. Make sure the file is valid.',
            });
        }
        ...
        <div className="container mx-auto px-4 py-8 space-y-6 max-w-3xl">
            ...
            <Card className="shadow-sm">
                <CardHeader className="border-l-4 border-l-accent rounded-tl-lg">
                    ...
                    <CardDescription>
                        Estimate daily calories and macros based on your body and goals
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6 pt-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                        <div className="space-y-2">
                            <Label htmlFor="calc-weight" className="text-muted-foreground">
                                Weight
                            </Label>
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="calc-height" className="text-muted-foreground">
                                Height
                            </Label>
                            <div className="relative">
                                <Input
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="calc-age" className="text-muted-foreground">
                                Age
                            </Label>
                            <div className="relative">
                                <Input
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            {(
                                ...
                                >
                                    <span
                                        className={`text-sm font-medium ${calcGoal === key ? 'text-primary' : ''}`}
                                    >
                                        {label}
                                    </span>
                        ...
                        <div className="p-4 rounded-lg bg-muted/30 space-y-3">
                            ...
                            <div className="flex justify-center gap-4 text-sm font-medium">
                                <span style={{ color: 'var(--macro-protein)' }}>
                                    P: {calcResult.macros.protein}g
                                </span>
                                <span style={{ color: 'var(--macro-carbs)' }}>
                                    C: {calcResult.macros.carbs}g
                                </span>
                                <span style={{ color: 'var(--macro-fat)' }}>
                                    F: {calcResult.macros.fat}g
                                </span>
                            </div>
                        </div>
                    )}
                ...
                <CardContent className="space-y-6 pt-6">
                    ...
                    <div>
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                <Label htmlFor="calories" className="text-muted-foreground">
                                    Calories
                                </Label>
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange('dailyCalories', e.target.value)
                                        }
                                        min="0"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="protein" className="text-muted-foreground">
                                    Protein
                                </Label>
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange('dailyProtein', e.target.value)
                                        }
                                        min="0"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="carbs" className="text-muted-foreground">
                                    Carbs
                                </Label>
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange('dailyCarbs', e.target.value)
                                        }
                                        min="0"
                                        className="pr-8 text-lg font-semibold"
                                    />
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="fat" className="text-muted-foreground">
                                    Fat
                                </Label>
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange('dailyFat', e.target.value)
                                        }
                                        min="0"
                                        className="pr-8 text-lg font-semibold"
                                    />
                    ...
                    <div>
                        ...
                        <div className="grid gap-4 sm:grid-cols-3">
                            <div className="space-y-2">
                                <Label htmlFor="fiber" className="text-muted-foreground">
                                    Fiber (min)
                                </Label>
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange('dailyFiber', e.target.value)
                                        }
                                        min="0"
                                        className="pr-8"
                                    />
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="sugar" className="text-muted-foreground">
                                    Sugar (max)
                                </Label>
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange('dailySugar', e.target.value)
                                        }
                                        min="0"
                                        className="pr-8"
                                    />
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="salt" className="text-muted-foreground">
                                    Salt (max)
                                </Label>
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange('dailySalt', e.target.value)
                                        }
                                        min="0"
                                        step="0.1"
                                        className="pr-8"
            ...
            <Card className="shadow-sm">
                ...
                <CardContent className="pt-6">
                    ...
                    <p className="text-sm text-muted-foreground mt-4 max-w-prose">
                        Export your data as a JSON file for backup. You can import it later to
                        restore your data.
                    </p>
                    ...
                    <div className="border-t pt-4 mt-4">
                        ...
                        <p className="text-xs text-muted-foreground mt-2 max-w-prose">
                            Delete all food log history and templates. Your saved foods will be
                            kept.
                        </p>
                    </div>
                </CardContent>
            ...
            <Card className="shadow-sm bg-muted/30">
                ...
                <CardContent className="text-sm text-muted-foreground space-y-3 max-w-prose">
                    ...
                    <p>
                        A simple calorie and nutrition tracker using Open Food Facts database with
                        focus on German/European products.
                    </p>
            ...
            <AlertDialog open={showResetDialog} onOpenChange={setShowResetDialog}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will delete all food log history and templates, but keep your saved
                            foods. This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
