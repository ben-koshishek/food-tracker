...
import {
    ...
    searchSavedFoods,
    addFoodEntry,
    findOrCreateSavedFoodFromEntry,
    addMealTemplate,
    addMealTemplateItem,
    addDayTemplate,
    addDayTemplateMeal,
...
export function Log() {
    ...
    const handleSaveDayTemplate = async () => {
        ...
        try {
            ...
            const dayTemplateId = await addDayTemplate({
            ...
            for (const [mealNum, mealEntries] of groups) {
                ...
                const mealTemplateId = await addMealTemplate({
    ...
    return (
        <div className="container mx-auto px-4 py-8 space-y-6">
            ...
            {error && (
                <div
                    role="alert"
                    className="fixed top-20 right-4 z-50 p-4 rounded-lg shadow-lg border bg-destructive/10 border-destructive/20 text-destructive animate-in slide-in-from-right"
                >
            ...
            {successMessage && (
                <div
                    role="status"
                    className="fixed top-20 right-4 z-50 p-4 rounded-lg shadow-lg border bg-primary/10 border-primary/20 text-primary animate-in slide-in-from-right"
                >
                    <div className="flex items-center gap-2">
                        <svg
                            className="w-5 h-5"
            ...
            <Dialog open={showAddFood} onOpenChange={(open) => !open && setShowAddFood(false)}>
                <DialogContent className="max-w-md">
                    <DialogHeader>
                        <DialogTitle>{selectedFood ? 'Set Serving Size' : 'Add Food'}</DialogTitle>
                    </DialogHeader>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            if (inputMode !== 'grams') {
                                                ...
                                                setServingSize(
                                                    Math.round(
                                                        servings * getServingInfo().weight,
                                                    ).toString(),
                                                );
                                                setInputMode('grams');
                                            }
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div className="flex-1 text-center">
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        = {Math.round(getGramsFromInput())}g
                                                    </p>
                                                </div>
                                                <Button
                                                    type="button"
                                                    ...
                                                    onClick={() =>
                                                        setServingSize(
                                                            (parseInt(servingSize) + 1).toString(),
                                                        )
                                                    }
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(v) =>
                                                setSelectedMealNumber(parseInt(v))
                                            }
                                        >
            ...
            <Dialog
                ...
                onOpenChange={(open) => !open && setSavingMeal(null)}
            >
                <DialogContent className="max-w-sm">
                    ...
                    <div className="space-y-4">
                        <p className="text-sm text-muted-foreground">
                            Save {savingMeal?.entries.length} item
                            {savingMeal?.entries.length !== 1 ? 's' : ''} as a reusable template.
                        </p>
                        <div className="space-y-2">
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            ...
                            disabled={!saveMealName.trim() || isSaving}
                        >
                ...
                <DialogContent className="max-w-sm">
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            ...
                            disabled={!saveDayName.trim() || isSaving}
                        >
                            {isSaving ? 'Saving...' : 'Save Template'}
                        </Button>
                    </DialogFooter>
