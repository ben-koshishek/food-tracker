                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="col-span-2 p-5 bg-secondary rounded-xl">
                                ...
                                <div className="flex items-baseline gap-2">
                                    <span
                                        className={`text-4xl font-bold tabular-nums ${isOverGoal ? 'text-destructive' : ''}`}
                                    >
                                ...
                                <p
                                    className={`text-sm mt-1 ${isOverGoal ? 'text-destructive' : 'text-success'}`}
                                >
                                    {isOverGoal
                                        ? `${Math.round(todayTotals.calories - calorieGoal)} over`
