...
const BASE_URL = import.meta.env.DEV ? '/api/off' : 'https://world.openfoodfacts.org/api/v2';
...
function normalizeProduct(product: OpenFoodFactsProduct): NormalizedProduct | null {
    ...
    return {
        ...
        ...parseServingUnit(
            ...
            product.serving_quantity ? Number(product.serving_quantity) : undefined,
        ),
